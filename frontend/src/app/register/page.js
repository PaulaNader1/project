...
export default function Register() {
    ...
    const validateForm = () => {
        ...
        if (password.length < 8 || !/[!@#$%^&*]/.test(password)) {
            passwordError = 'Password must be at least 8 characters long and contain a special character';
            isValid = false;
        }
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
            <form onSubmit={onSubmit} style={{
                ...
                <h1 style={{ fontSize: '1.8rem', color: '#333', marginBottom: '20px' }}>Create an Account</h1>
